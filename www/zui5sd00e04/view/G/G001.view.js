sap.ui.jsview("zui5sd00e04.view.G.G001", {
	...
	*/ 
	getControllerName : function() {
		return "zui5sd00e04.controller.G.G001";
	},
		...
		var g001RowOvw = new sap.m.ColumnListItem({
			...
			cells	:[new sap.m.ObjectIdentifier({title:'{matnr_px} {maktx_px}',
			     	  ...
			     	  new sap.m.Button({
			     		   	...
			     		   	icon			: "sap-icon://less",}),
			     	  //new sap.m.Link({text:"{menge_ist}",press:oController.fcodeEdt}),								// +- 2018.10.30 :: Finishing V1.0.1
