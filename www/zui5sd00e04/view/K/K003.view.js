sap.ui.jsview("zui5sd00e04.view.K.K003", {
	...
	*/ 
	getControllerName : function() {
		return "zui5sd00e04.controller.K.K003";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		var k003RowOvw = new sap.m.ColumnListItem({
			...
			cells	:[new sap.m.ObjectIdentifier({title: {path:'piknr',formatter:oFmt.fmtAlpha},
			     	  ...
			     	  new sap.m.ObjectIdentifier({title: '{menge_opk}', 
			     		  						  text : '{meins_pkx}'}),
			     	  new sap.m.ObjectIdentifier({title: '{vlenr}', 
				     		  					  text : '{vlpla}'}),]
		}); 
		...
		var k003btnHom    = new sap.m.Button({id:'k003btnHom',icon:"sap-icon://home",press:oCon.ui5Dispatch});
		
		var k003page = new sap.m.Page({
			id				: 'k003page',
			customHeader	: new sap.m.Bar({contentLeft:	[k003btnBck,k003btnHom],
