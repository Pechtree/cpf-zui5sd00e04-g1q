sap.ui.jsview("zui5sd00e04.view.F.F402", {
	...
	*/ 
	getControllerName : function() {
		return "zui5sd00e04.controller.F.F402";
	},
	...
	*/ 
	createContent : function(oController) {
		...
		//Page
		//-------------------------------------------------------------------------------
		var f402txtTot	  = new sap.m.Text({id:'f402txtTareTot',visible:false});
   		var f402DiaWei    = oApp.diaWeight('f402');
   		var f402TxtTabix  = new sap.m.Text({id:"f402TxtTabix",visible:false,text:"{/wei/tabix}"});
