sap.ui.jsview("zui5sd00e04.view.D.D402", {
	...
	*/ 
	getControllerName : function() {
		return "zui5sd00e04.controller.D.D402";
	},
	...
	*/ 
	createContent : function(oController) {
			...
			cells	:[new sap.m.ObjectIdentifier({title : '{matnr_px} {maktx_px}',
				      ...
				      new sap.m.ObjectIdentifier({title : '{menge_bst}',
			     	  ...
			     	  new sap.m.Button({press			: oController.fcodeDec,
			     					    icon			: "sap-icon://less",}),
			     	  //new sap.m.Link({text:"{menge_ist}",press:oController.fcodeEdt}),									// +- 2018.10.25 :: TFR-PRMX V1.2.1
			     	  new sap.m.Link({text:"{menge_ist13_6}",press:oController.fcodeEdt}),									// Change 'menge_ist' to 6 digit
		...
		//-------------------------------------------------------------------------------
   		...
   		var d402pullMain  = oCon.getPullMain('d402','SAPEVT_D412','evt_d412');
