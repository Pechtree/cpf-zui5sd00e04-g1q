sap.ui.jsview("zui5sd00e04.view.A.A002", {
	...
	*/ 
	getControllerName : function() {
		return "zui5sd00e04.controller.A.A002";
	},
...
//		}));
		...
		a002frm03.addContent(new sap.m.Input({id:"a002InpBMargin",value:'{/dev_bth/margin}',editable:true}));
		a002frm03.addContent(new sap.m.Input({id:"a002InpBQrSize",value:'{/dev_bth/qrsize}',editable:true}));
		a002frm03.addContent(new sap.m.Input({id:"a002InpBFont",value:'{/dev_bth/font}',editable:false}));
		...
		a002frm04.addContent(new sap.m.Input({id:"a002InpPMargin",value:'{/dev_prn/margin}',editable:true}));
		a002frm04.addContent(new sap.m.Input({id:"a002InpPQrSize",value:'{/dev_prn/qrsize}',editable:true}));
		a002frm04.addContent(new sap.m.Input({id:"a002InpPFont",value:'{/dev_prn/font}',editable:false}));
