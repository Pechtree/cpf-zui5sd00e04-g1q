sap.ui.controller("zui5sd00e04.G.G000", {
	//--------------------------------------------------------------------------------	
	//PAI FCODE 
	//--------------------------------------------------------------------------------	
	M01_FCD: function(fcode,oModela){
		...
		if(fcode=='g001btnAcp'){//Edit - OK
			oCon.getCell('g001TblOvw',4).setText(oCon.fmtDec(oCon.getControl('g001inpOrder').getValue(),3));
		};
		//-------------------------------------------------------------------- G002
		if(fcode=='g002inpQr'){
	...
	M02_PAR: function(fcode,oModela){
		...
		if(fcode=="SAPEVT_G002"){ //List Ingredient for Backflush
			return oParameters = { 
				...
				"imenge" 	: oCon.getProperty('g001TblOvw','menge_ist'),
			};
		};
