sap.ui.controller("zui5sd00e04.proc.E100", {
	//--------------------------------------------------------------------------------	
	//PAI FCODE 
	//--------------------------------------------------------------------------------	
	...
	M06_NEX: function(fcode,oModela){
		...
		if(fcode=='SAPEVT_E103'&&oModela.oData.logon.typ=='S'&oCon.getControl('e104InpPrint').getValue()=='X'){
			oApp.diaPrint_PBO('e104','PIK',
				oCon.getControl('e104InpMatnrA').getValue(),		// Material
				oCon.getControl('e104InpChargA').getValue(),		// Batch
				oCon.getControl('e104InpMengeA').getValue(),		// Qty
				oCon.getControl('e104InpMeinsA').getValue(),		// UOM
				oCon.getControl('e104InpMengeA').getValue(),		// Base Qty
				oCon.getControl('e104InpQrcodA').getValue(),		// Scaned QR code
				'',													// Process Order 
				'',													// Set No.
				'',													// Picking Order
				'',													// Picking Item
