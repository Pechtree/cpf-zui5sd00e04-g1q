sap.ui.jsview("zui5sd00e04.I.I103", {
	...
	*/ 
	createContent : function(oController) {
		...
		var i103RowIng = new sap.m.ColumnListItem({
			...
			cells	:[new sap.m.ObjectIdentifier({title: {path:"cnfnr",formatter:oFmt.fmtAlpha},
											      text : '{charg}'}),
...
//												  text : '{vornr} {bezei}'}),
   		...
   		var i103TblCnf = new sap.m.Table({
   			...
   			columns		: [oCon.getCol('08','Cnf-in','','','i103TblCnf','cnfnr'),
   			       		   //oCon.getCol('07','FG','','','i103TblCnf','matnr_fg'),,
   			       		   oCon.getCol('08','Start','','','i103TblCnf','isdd'),
   			       		   oCon.getCol('02','SET'),
   			       		   oCon.getCol('03',''),],
