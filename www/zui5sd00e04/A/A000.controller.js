sap.ui.controller("zui5sd00e04.A.A000", {
	//--------------------------------------------------------------------------------	
	//PAI FCODE 
	//--------------------------------------------------------------------------------	
	M01_FCD: function(fcode,oModela){
		...
		//----------------------------------------------------------------------  A003 (Tile)
		//if(fcode=='a003tilB000'){oCon.ui5DispatchBackEnd("SAPEVT_B001","evt_b001","{i18n>MSG_PROCESS}");}
		...
		if(fcode=='a003tilD400'){oCon.ui5DispatchBackEnd("SAPEVT_D401","evt_d401","{i18n>MSG_PROCESS}");}
		if(fcode=='a003tilD104'){oCon.ui5DispatchBackEnd("SAPEVT_D104","evt_d104","{i18n>MSG_PROCESS}");}
		if(fcode=='a003tilD200'){oCon.ui5DispatchBackEnd("SAPEVT_D201","evt_d201","{i18n>MSG_PROCESS}");}
		...
		if(fcode=='a003tilE300'){oCon.ui5DispatchBackEnd("SAPEVT_E301","evt_e301","{i18n>MSG_PROCESS}");}
		...
		if(fcode=='a003tilI000'){oCon.ui5DispatchBackEnd("SAPEVT_I001","evt_i001","{i18n>MSG_PROCESS}");}
		...
		//----------------------------------------------------------------------  A001 (List)
		if(fcode=='a001tilB000'){oCon.ui5DispatchBackEnd("SAPEVT_B001","evt_b001","{i18n>MSG_PROCESS}");}
