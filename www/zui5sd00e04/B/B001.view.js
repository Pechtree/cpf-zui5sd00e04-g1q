sap.ui.jsview("zui5sd00e04.B.B001", {
	...
	*/ 
	createContent : function(oController) {
		...
		//-------------------------------------------------------------------------------
   		...
   		//var inpDate2 = oCon.getDatePicker('b001inpBedat');
   		inpDate1.setValue(oCon.getDateIn());
   		//inpDate2.setValue(oCon.getDateIn());
   		...
   		//b001frmSel.addContent(new sap.m.Label({text:'PO Date'}));
   		//b001frmSel.addContent(inpDate2);
		var b001DiaSel = new sap.m.Dialog({
			...
			customHeader	: new sap.m.Bar({contentLeft:	[new sap.m.Button({icon:"sap-icon://eraser",press:function(){
																...
																//oCon.getControl('b001inpBedat').setValue();
		...
		//Page
		//-------------------------------------------------------------------------------
   		var b001schMain   = oCon.getSchMain('b001','b001TblOvw',['ebeln','lifnr','name1','eindt']);
   		var b001pullMain  = oCon.getPullMain('b001','SAPEVT_B001','evt_b001');
