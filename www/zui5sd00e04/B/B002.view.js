sap.ui.jsview("zui5sd00e04.B.B002", {
	...
	*/ 
	createContent : function(oController) {
		...
		var b002RowOvw = new sap.m.ObjectListItem({
			...
			firstStatus		: new sap.m.ObjectStatus({title:'Order',text:'{menge_rkg}'}),
			secondStatus	: new sap.m.ObjectStatus({title:'Rcv',text:'{menge_ckg}'}),
			attributes 		: [new sap.m.ObjectAttribute({title:'V.Batch',text:'{charg}',visible:false}),
			           	       new sap.m.ObjectAttribute({title:'Manu Dat',visible:false}),
			           		   new sap.m.ObjectAttribute({title:'GR',text:'{menge_ikg}'}),
		...
		//-------------------------------------------------------------------------------
   		...
   		//var b002pullMain  = oCon.getPullMain('b002','SAPEVT_B002','evt_b002');
		...
		var b002page = new sap.m.Page({
			id				: 'b002page',
			customHeader	: new sap.m.Bar({contentLeft:	[b002btnBck],
