sap.ui.jsview("zui5sd00e04.L.L103", {
	...
	*/ 
	createContent : function(oController) {
		...
		//-------------------------------------------------------------------------------
   		...
   		l103FrmMain.addContent(new sap.m.Label({text:''}));
   		l103FrmMain.addContent(new sap.m.Input({id:'l103InpSlocNumber',editable:false,value:'{/t_l_iromat/0/lgort}'}));
		...
		//-------------------------------------------------------------------------------
   		...
   		var l103DiabtnSav	= new sap.m.Button({id:'l103DiabtnSav',icon:"",text:'ตกลง',press:oCon.ui5Dispatch});
   		var l103DiabtnCanc 	= new sap.m.Button({id:'l103DiabtnCanc',icon:"",text:'ยกเลิก',press:oCon.ui5Dispatch});
...
//	};
		...
		//Check QTY Dialog
		//-------------------------------------------------------------------------------
   		var l103DiaChkTitle  = new sap.m.Label({id:'l103DiaChkTitle',design:sap.m.LabelDesign.Bold,text:"โปรดตรวจสอบ"});
   		
   		var l103DiaChkQTY  		= new sap.m.Text({id:'l103DiaChkQTY',visible:false,text:"ช่อง Qty: จำนวนที่มากกว่า 0\n"});
   		var l103DiaChkQTYUnit	= new sap.m.Text({id:'l103DiaChkQTYUnit',visible:false,text:"ช่อง Qty: ระบุหน่วย\n"});
   		
   		var l103DiaChkFlexBox = new sap.m.VBox({
			items : [l103DiaChkQTY,l103DiaChkQTYUnit]
		});
   		
   		var l103DiaChkbtnOK	= new sap.m.Button({id:'l103DiaChkbtnOK',icon:"",text:'ตกลง',press:oCon.ui5Dispatch})
